...
android {
 ...
 defaultConfig { applicationId = "cn.edu.sycu.schedule"; minSdk = 26; targetSdk = 36; versionCode = providers.environmentVariable("ZHIXU_VERSION_CODE").orElse("2003").get().toInt(); versionName = providers.environmentVariable("ZHIXU_VERSION_NAME").orElse("0.2.2").get(); testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner"; buildConfigField("String", "RELEASE_CERT_SHA256", "\"\"") }
 defaultConfig {
